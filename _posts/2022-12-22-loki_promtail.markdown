...
best path forward vs over-complicating the PromQL config file(s). There are multiple ways to do this and your choice 
will most likely be made based on the shape any format of your log files. Some of these ways include:
...
The labels generated by the above pattern parse statement are ip, dttm, method, etc.. I can not take these labels
